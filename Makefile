...
#Oper_Unit_Test
Oper.o : $(USER_DIR)/Oper.cpp $(USER_DIR)/Oper.h
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(USER_DIR)/Oper.cpp

oper_test.o : $(TEST_DIR)/oper_test.cpp $(USER_DIR)/Oper.h $(GTEST_HEADERS) 
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(TEST_DIR)/oper_test.cpp

oper_test : Oper.o oper_test.o gtest_main.a
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -lpthread $^ -o $@
